...
<body>
  ...
  <form id="form1" name="form1" class="form" method="get" action="articles élec.php">
    <div class="container">
          <label for="textfield"><b>code E</b></label>
          <input type="text" name="A" id="textfield" placeholder="code E..." >
...
$r="insert into `$t` (`codeE`,`type`,`nombre d'unitées`,`codeM`) values ('$A','$B','$C','$D')";
$req=$id->prepare($r);
$e=$req->execute();
