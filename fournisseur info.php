...
<body>
  ...
  <form id="form1" name="form1" class="form" method="get" action="fournisseur info.php">
    <div class="container">
          <label for="textfield"><b>code Fi</b></label>
          <input type="text" name="X" id="textfield" placeholder="code Fi..." >
...
$r="insert into `$t` (`codeFi`,`nom`,`codeA`) values ('$A','$B','$C')";
$req=$id->prepare($r);
$e=$req->execute();
