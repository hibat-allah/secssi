...
<body>
  ...
  <form id="form1" name="form1" class="form" method="get" action="Magasin.php">
    <div class="container">
          <label for="textfield"><b>code M</b></label>
          <input type="text" name="A" id="textfield" placeholder="code M..." >
      
          <label for="textfield2"><b>nom du magasin</b></label>
          <input type="text" name="B" placeholder="nom du magasin..." >

          <label for="textfield3"><b>articles informatiques</b></label>
          <input type="text" name="C" placeholder="articles informatiques..." >

          <label for="textfield4"><b>articles électroménager</b></label>
          <input type="text" name="B" placeholder="articles électroménager..." >
...
$r="insert into `$t` (`codeM`,`nom du magasin`,`articles informatiques`,`articles électroménager`) values ('$A','$B','$C','$D')";
$req=$id->prepare($r);
$e=$req->execute();
