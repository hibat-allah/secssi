...
<body>
  ...
  <form id="form1" name="form1" class="form" method="get" action="mvt de stocks info2.php">
    <div class="container">
...
<?php
echo '<p>les clés (date d`entrée) stockés actuélment sont: 2020-10-15 2020-10-16 </p>';
