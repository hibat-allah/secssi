...
<body>
  ...
  <form id="form1" name="form1" class="form" method="get" action="mouvements de stocks élec.php">
    <div class="container">
...
$r="insert into `$t` (`$t`.`date d'entrée`,`$t`.`date de sortie`,`codeE`) values ('$A','$B','$C') ";
$req=$id->prepare($r);
$e=$req->execute();
